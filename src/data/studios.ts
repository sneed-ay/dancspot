...
export const studios: Studio[] = [
  ...
  // 社交ダンス教室 (tokyo-062 〜 tokyo-092)
  {
    ...
    danceStyles: ["ワルツ", "タンゴ", "フォックストロット", "クイックステップ", "ヴィエニーズワルツ", "ルンバ", "チャチャチャ", "サンバ", "パソドブレ", "ジャイブ"],
    lessonTypes: ["グループ", "個人", "体験"],
    description: "銀座駅B4・C6出口から徒歩1分。初心者から経験者まで楽しめるクラス構成の社交ダンススタジオ。",
  },
  {
    id: "tokyo-063",
    name: "二宮清ダンスアカデミー",
    ...
    prefectureName: "東京都",
    city: "中央区",
    address: "東京都中央区銀座5-14-17 銀座USBビル201",
    phone: "03-3543-1388",
  ...
  },
  {
    ...
    danceStyles: ["ワルツ", "タンゴ", "フォックストロット", "クイックステップ", "ヴィエニーズワルツ", "ルンバ", "チャチャチャ", "サンバ", "パソドブレ", "ジャイブ"],
    lessonTypes: ["グループ", "個人", "体験"],
    description: "下高井戸駅徒歩3分。10名のインストラクターが在籍し初心者向けクラスが充実。",
  },
  {
    id: "tokyo-071",
    name: "豪徳寺ダンススクール",
    ...
    danceStyles: ["ワルツ", "タンゴ", "フォックストロット", "クイックステップ", "ヴィエニーズワルツ", "ルンバ", "チャチャチャ", "サンバ", "パソドブレ", "ジャイブ"],
    lessonTypes: ["グループ", "個人", "体験"],
    description: "豪徳寺駅徒歩2分。ジュニアからシニアまで幅布く対応するグループ・個人レッスン。",
  },
  {
    id: "tokyo-072",
    name: "篠田忠ダンスカレッジ",
    ...
    danceStyles: ["ワルツ", "タンゴ", "フォックストロット", "クイックステップ", "ヴィエニーズワルツ", "ルンバ", "チャチャチャ", "サンバ", "パセドブレ", "ジャイブ"],
    lessonTypes: ["グループ", "個人", "体験"],
    description: "武蔵小山駅徒歩3分。1990年開設の苵国式正統社交ダンス教室。初心者からプロまで対応。",
  },
  {
    id: "tokyo-073",
    name: "助川ダンス教室",
  ...
  },
  {
    ...
    danceStyles: ["ワルツ", "タンゴ", "フォックストロット", "クイックステップ", "ヴィエニーズワルツ", "ルンバ", "チャチャチャ", "サンバ", "パセドブレ", "ジャイブ"],
    lessonTypes: ["グループ", "個人", "体験"],
    description: "五反田の社交ダンススクール。丁寧な個人指導が評判。",
  },
  {
    id: "tokyo-075",
    name: "ダンススタジオコネクト橘",
    ...
    prefectureName: "東京都",
    city: "豊島区",
    address: "東京都豊島区駒込3-3-19 ORCHID PLACE 9F",
    phone: "03-5394-2229",
  ...
  },
  {
    ...
    danceStyles: ["ワルツ", "タンゴ", "フォックストロット", "クイックステップ", "ヴィエニーズワルツ", "ルンバ", "チャチャチャ", "サンバ", "パソドブレ", "ジャイブ"],
    lessonTypes: ["グループ", "個人", "体験"],
    description: "町田の社交ダンススタジオ。初心者からプロまで個人・団体レッスンが充実。",
  },
  {
    id: "tokyo-089",
    name: "大塚出ダンススクール",
